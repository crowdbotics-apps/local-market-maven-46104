"""
Django settings for local_market_maven_46104 project.
...
ROOT_URLCONF = 'local_market_maven_46104.urls'
...
WSGI_APPLICATION = 'local_market_maven_46104.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "local_market_maven_46104 API",
    "DESCRIPTION": "API documentation for local_market_maven_46104 App",
    "VERSION": "v1",
}
